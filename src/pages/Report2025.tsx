...
const Report2025 = () => {
  ...
  const getCompanyUrl = (companyName: string): string => {
    ...
    const urlMap: { [key: string]: string } = {
      ...
      'director.ai': 'https://www.browserbase.com/blog/introducing-director',
      ...
      'kaizen': 'https://www.kaizenautomation.com/',
      'bright data': 'https://brightdata.com/',
      'browser.ai': 'https://brightdata.com/products/scraping-browser',
      'apify': 'https://apify.com/',
      'firecrawl': 'https://www.firecrawl.dev/',
      'omniparser': 'https://microsoft.github.io/OmniParser/',
      'perplexity search api': 'https://docs.perplexity.ai/guides/search-guide',
      'google gemini 2.5': 'https://ai.google.dev/gemini-api/docs/computer-use',
      'google gemini 2.5 computer use model': 'https://ai.google.dev/gemini-api/docs/computer-use',
      'chrome': 'https://www.google.com/chrome/',
      'coact-1': 'https://linxins.net/coact/',
      'axiom-1': 'https://inductionlabs.com/news/axiom-1',
      'axiom-1 by induction labs': 'https://inductionlabs.com/news/axiom-1',
      'opencua': 'https://opencua.xlang.ai/',
      'qwen2.5-vl': 'https://qwen.ai/research',
      'glm-4.5v': 'https://bigmodel.cn/',
      'anthropic claude': 'https://claude.com/',
      'anthropic claude computer use': 'https://claude.com/',
      ...
      'copycat': 'https://www.runcopycat.com/',
      ...
      'please': 'https://please.ai/',
      'kairos': 'https://www.kairos.computer/',
      'dex': 'https://www.thirdlayer.inc/',
      ...
      'strawberry browser': 'https://www.strawberrybrowser.com/',
    };
